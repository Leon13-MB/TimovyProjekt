            ...
            if (wifi.isOn())
            {
                if (txtUsername.Text != null && txtPassword.Text != null)
                {
                    ...
                    if (user.CheckInformation())
                    {
                        ...
                        {
                            ActivitySpinner.IsVisible = false;
                            await DisplayAlert("Prihlásenie", "Prihlásenie úspešné", "Okej");
                    ...
                    {
                        await DisplayAlert("Prihlásenie", "Prihlásenie nesprávne, nesprávne použiveteľské meno alebo heslo", "Okej");
